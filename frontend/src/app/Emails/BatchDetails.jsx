      ...
      return (
        <span>
          <svg
            ...
            fill-rule="evenodd"
            clip-rule="evenodd"
            viewBox="0 0 512 455.174"
          >
            <path
              fill="#fff"
              fill-rule="nonzero"
              d="M0 110.808h97.648l56.86 145.466 57.6-145.466h95.066L164.022 455.174H68.338l39.188-91.251L.003 110.808H0zM417.88 227.04H311.4L405.907 0 512 .005 417.88 227.04zm-78.588 21.73c32.672 0 59.155 26.485 59.155 59.15 0 32.668-26.483 59.153-59.155 59.153-32.667 0-59.146-26.485-59.146-59.153 0-32.665 26.483-59.15 59.146-59.15z"
            />
          </svg>
          Yahoo
        </span>
      ...
      return (
        <span>
          <svg
            ...
            enableNackground="new 0 0 1831.085 1703.335"
          >
            <path
              fill="#0A2767"
