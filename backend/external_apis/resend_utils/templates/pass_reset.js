...
const resend_template_PasswordReset = (resetLink) => {
	return (`
													...
													<tr>
														<td>
															...
															<p style="font-size:16px;line-height:24px;color:rgb(0,0,0);margin-bottom:24px;margin-top:16px;text-align:center">
																We received a request to reset your OmniVerifier account password. If you made this request, click the button below to create a new password.
															</p>
															<table
																align="center"
																width="100%"
