													...
													<tbody>
														<tr>
															<td>
																...
																<p style="font-size:16px;line-height:24px;color:rgb(0,0,0);margin-bottom:24px;margin-top:16px">
																	This one-time password will expire in 10 minutes for security purposes.
																</p>
																<p style="font-size:16px;line-height:24px;color:rgb(0,0,0);margin-bottom:24px;margin-top:16px">
																	If you didn&#x27;t request a one-time password, you can safely ignore this email. Your account will remain secure.
																</p>
															</td>
														</tr>
													</tbody>
