...
CREATE TABLE Users (
	...
	`name` varchar(125) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL,
	`email` varchar(125) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
	`profile_picture` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL,
